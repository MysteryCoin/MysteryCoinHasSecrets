...
static const int64 nTargetTimespan = 192;
static const int64 nTargetSpacing = 24;
...
bool LoadBlockIndex()
{
   if (fTestNet)
   {
       ...
       hashGenesisBlock = uint256("0x00000000d7ac30aea6cde75da5d101576b0259e50157674246263a85b0ae9185");
   }
...
bool InitBlockIndex() {
   ...
   if (!fReindex) {
       ...
       block.nVersion = 1;
       block.nTime    = 1404115660;
       block.nBits    = 486604799;
       block.nNonce   = 3215579857;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
   ...
   // Found a solution
   {
       ...
       if (pblock->hashPrevBlock != hashBestChain)
           return error("MysteryCoinMiner : generated block is stale");
       ...
       if (!ProcessBlock(state, NULL, pblock))
           return error("MysteryCoinMiner : ProcessBlock, block not accepted");
   }
...
{
   printf("MysteryCoinMiner started\n");
   ...
   try { loop {
       ...
       printf("Running MysteryCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
   ...
   {
       printf("MysteryCoinMiner terminated\n");
       throw;
   }
}
